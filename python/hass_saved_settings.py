...
BEGIN CUSTOMIZE
"""
path = "/var/opt/homeassistant/saved_input-settings.ini"         # Path to ini file. ex. "/home/mike/.homeassistant/saved_input_settings.ini"
host = "localhost:8123"         # Host & Port of Home-Assistant. ex. "localhost:8123"
api_key = "in3126es"    # Frontend / API Info. ex. "MyHassPassword"
